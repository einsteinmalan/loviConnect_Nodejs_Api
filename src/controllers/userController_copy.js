...
// //   (request, response) => {
// //     const { school_id, quiz_id, question, correct_answer, explanation } =
// //       request.body;
// //     const id = uuid.v4();
...
// export async function saveUserPic(req, res) {
//   const { type, userId } = req.body;
//   const file = req.file;
//   var filePath = "N/A";
//   if (file != null) {
//     filePath = file.path;
//     const result = await userModel.saveUserImage(userId, type, filePath);
//     if (result.error) {
...
//       status: 400,
//       data: [],
//       message: "Bad request! No image provided",
//     });
//   }
// }
