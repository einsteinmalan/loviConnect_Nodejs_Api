...
let valid_password = (req, res, next) => {
  ...
  if (!form_validator.isSafePass(req.body.password)) {
    errors.password =
      "Password must contain at least 6 characters and at least 1 alphabet and 1 number";
  }
  if (
    !form_validator.isSamePass(req.body.password, req.body.confirm_password)
  ) {
